...
for shift_register in shift_registers:
    initialize_registers(shift_registers["data_pin"], shift_registers["clock_pin"], shift_registers["latch_pin"])

# SectionA = threading.Thread(target=ShiftReg_send_data, args=(shift_registers[0]["data_pin"], shift_registers[0]["clock_pin"], shift_registers[0]["latch_pin"], data))
# SectionB = threading.Thread(target=ShiftReg_send_data, args=(shift_registers[1]["data_pin"], shift_registers[1]["clock_pin"], shift_registers[1]["latch_pin"], data))
# SectionC = threading.Thread(target=ShiftReg_send_data, args=(shift_registers[2]["data_pin"], shift_registers[2]["clock_pin"], shift_registers[2]["latch_pin"], data))
# SectionD = threading.Thread(target=ShiftReg_send_data, args=(shift_registers[3]["data_pin"], shift_registers[3]["clock_pin"], shift_registers[3]["latch_pin"], data))
# Cathodes = threading.Thread(target=ShiftReg_send_data, args=(shift_registers[4]["data_pin"], shift_registers[4]["clock_pin"], shift_registers[4]["latch_pin"], data))
